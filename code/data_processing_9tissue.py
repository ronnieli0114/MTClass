...
def parse_GTEx_data(data_dir=r'F:/lab_data', save_files=False):
...
def load_GTEx_data(data_dir=r'F:/lab_data/mtclass_eqtl/multi-tissue/'):
...
def sample_availability(data_dir=r'F:/lab_data/mtclass_eqtl/multi-tissue/'):
...
def make_9tissue_features(data_dir=r"F:/lab_data/mtclass_eqtl/multi-tissue/", num_tissues=9):
...
def create_TPM_to_impute(data_dir=r"F:/lab_data/mtclass_eqtl/multi-tissue"):
